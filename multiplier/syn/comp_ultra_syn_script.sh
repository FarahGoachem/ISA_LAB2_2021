...
elaborate FPmul_pipeline -arch pipeline -lib WORK > ./reports/comp_ultra_elaborate.txt
...
report_timing -attributes > ./reports/comp_ultra_report_timing_clk_max.txt

report_area > ./reports/comp_ultra_report_area_max.txt

report_resources > ./reports/comp_ultra_report_resources.txt
