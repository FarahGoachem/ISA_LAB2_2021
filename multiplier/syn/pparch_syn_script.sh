...
elaborate FPmul_pipeline -arch pipeline -lib WORK > ./reports/pparch_elaborate.txt
...
report_timing -attributes > ./reports/pparch_report_timing_clk_max.txt

report_area > ./reports/pparch_report_area_max.txt

report_resources > ./reports/pparch_report_resources.txt
